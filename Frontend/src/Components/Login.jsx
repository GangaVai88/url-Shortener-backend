...
function Login({setToken, setIsLogin}){
    ...
    return (
  <form onSubmit={handleLogin} className="bg-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-700/50 w-full max-w-md flex flex-col gap-5">
    <input
      type="email"
